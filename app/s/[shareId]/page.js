      ...
      <main className="mx-auto max-w-4xl px-4 py-8 md:px-8">
        ...
        {status === 'notfound' && (
          <div className="rounded-md border border-border bg-card p-10 text-center">
            ...
            <Link href="/" className="mt-6 inline-flex items-center gap-2 rounded-md bg-foreground px-5 py-2.5 text-sm font-medium text-background hover:bg-foreground/90">
        ...
        {status === 'ok' && item && (
          <>
            <div className="mb-4 flex flex-wrap items-center justify-between gap-2 rounded-md border border-border bg-card px-4 py-3 text-xs text-muted-foreground">
              <span className="font-mono uppercase tracking-[0.15em]">Read-only shared memory package</span>
              <Link href="/" className="text-brand hover:underline">Create your own with AI Memory →</Link>
            </div>
