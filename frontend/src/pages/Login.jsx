  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background text-foreground">
      ...
      <div className="relative flex items-center justify-between px-6 py-5 md:px-10">
        <Link to="/" data-testid="login-back-home" className="inline-flex items-center gap-2 font-mono text-sm text-muted-foreground transition-colors hover:text-foreground">
        ...
        <div className="w-full max-w-md animate-fade-up">
          ...
          <div className="rounded-md border border-border bg-card p-8">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Save memory packages, revisit your project history, and move context
              between any AI — securely tied to your account.
            </p>
