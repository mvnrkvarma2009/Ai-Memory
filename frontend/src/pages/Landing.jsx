...
const HERO_BG =
  "https://images.pexels.com/photos/7599718/pexels-photo-7599718.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940";
...
const steps = [
  ...
  { n: "02", title: "Generate the memory package", desc: "Claude Sonnet 4.6 extracts the true project state into clean, structured sections." },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 md:px-10 md:pb-32 md:pt-28">
          ...
          <motion.p variants={fadeUp} initial="hidden" animate="show" custom={2}
            ...
            You spent hours building with one AI. Then it hit its context limit. AI Memory turns
            that conversation into a structured memory package you can paste into any other AI —
            so it instantly understands the goal, the state, the decisions and what&apos;s next.
          </motion.p>

          <motion.div variants={fadeUp} initial="hidden" animate="show" custom={3}
            className="mt-9 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
            <button data-testid="hero-cta-btn" onClick={go}
            ...
            <a href="#how" data-testid="hero-secondary-btn"
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="show" custom={4}
            ...
            <div className="rounded-md border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                &ldquo;Ok so let me re-explain everything… the stack, what we already built,
                the decisions we made, the parts that broke…&rdquo; — 30 minutes gone, context still lossy.
              </p>
            </div>
            <div className="animate-processing rounded-md border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm leading-relaxed text-foreground">
                One paste. A structured package with goal, state, completed &amp; pending work,
                architecture decisions and next tasks. The new AI is caught up in seconds.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section id="how" className="border-b border-border bg-grid-lines">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10">
          ...
          <h2 className="mt-3 max-w-2xl text-2xl font-medium tracking-tight sm:text-3xl lg:text-4xl">
            Three steps. Zero re-explaining.
          </h2>
      ...
      <section id="usecases" className="border-b border-border">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10">
          ...
          <h2 className="mt-3 max-w-2xl text-2xl font-medium tracking-tight sm:text-3xl lg:text-4xl">
            Whoever you build with, your context comes along.
          </h2>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10">
          <div className="relative overflow-hidden rounded-md border border-border bg-card p-10 md:p-16">
            ...
            <div className="relative">
              ...
              <button data-testid="cta-bottom-btn" onClick={go}
